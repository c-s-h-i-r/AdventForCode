...
{
    internal class Day14 : BaseChallenge
    {
        //        --- Day 14: Space Stoichiometry ---
        //As you approach the rings of Saturn, your ship's low fuel indicator turns on.
        //There isn't any fuel here, but the rings have plenty of raw material.Perhaps your ship's Inter-Stellar Refinery Union brand nanofactory can turn these raw materials into fuel.
        ...
        //For example, the reaction 1 A, 2 B, 3 C => 2 D means that exactly 2 units of chemical D can be produced by consuming exactly
        //1 A, 2 B and 3 C.You can run the full reaction as many times as necessary; for example, you could produce 10 D by consuming 5 A, 10 B, and 15 C.
