...
//      in other words, don't reuse memory from a previous attempt.
    ...
    public class Day2
    {
        ...
        public Day2(string filePath = @"C:\Users\Chris\source\repos\AdventForCode Challenge\AdventForCode\inputDay2.txt")
        {
        ...
        public int RunChallengePart2()
        {
            ...
            var initialMemory = Program.ReadInput(this.filePath)[0];
